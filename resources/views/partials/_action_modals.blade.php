    ...
    <div class="modal-content modal-fullscreen">
        ...
        <div class="modal-body">
            ...
            <div class="file-viewer-main">
                ...
                <iframe id="fileViewerIframe" src="about:blank" frameborder="0"></iframe>
                
                <div class="modal-slider-controls" id="fileViewerSlider" style="display: none;">
                    <button id="prevFileBtn">&lt;</button>
                    <span id="fileCounter"></span>
                    <button id="nextFileBtn">&gt;</button>
                </div>
            </div>
        </div>
    </div>
